...
export   PWM_PH_C_EnableInt
export  _PWM_PH_C_EnableInt
export   PWM_PH_C_DisableInt
export  _PWM_PH_C_DisableInt
export   PWM_PH_C_Start
export  _PWM_PH_C_Start
export   PWM_PH_C_Stop
export  _PWM_PH_C_Stop
export   PWM_PH_C_WritePeriod
export  _PWM_PH_C_WritePeriod
export   PWM_PH_C_WritePulseWidth  
export  _PWM_PH_C_WritePulseWidth  
export   PWM_PH_C_WriteDeadTime  
export  _PWM_PH_C_WriteDeadTime  
export   PWM_PH_C_bReadPulseWidth
export  _PWM_PH_C_bReadPulseWidth
...
; for new designs.
export   bPWM_PH_C_ReadPulseWidth
export  _bPWM_PH_C_ReadPulseWidth
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_EnableInt
;
;  DESCRIPTION:
...
;-----------------------------------------------------------------------------
 PWM_PH_C_EnableInt:
_PWM_PH_C_EnableInt:
   M8C_EnableIntMask PWM_PH_C_INT_REG, PWM_PH_C_bINT_MASK
   ret	
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_DisableInt
;
;  DESCRIPTION:
...
;-----------------------------------------------------------------------------
 PWM_PH_C_DisableInt:
_PWM_PH_C_DisableInt:
   M8C_DisableIntMask PWM_PH_C_INT_REG, PWM_PH_C_bINT_MASK
   ret
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_Start
;
;  DESCRIPTION:
...
;-----------------------------------------------------------------------------
 PWM_PH_C_Start:
_PWM_PH_C_Start:
   or    REG[PWM_PH_C_PWM_CONTROL_REG], bfCONTROL_REG_START_BIT
   or    REG[PWM_PH_C_DB_CONTROL_REG], bfCONTROL_REG_START_BIT
   ret	
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_Stop
;
;  DESCRIPTION:
...
;-----------------------------------------------------------------------------
 PWM_PH_C_Stop:
_PWM_PH_C_Stop:
   and   REG[PWM_PH_C_PWM_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   and   REG[PWM_PH_C_DB_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   ret	
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_WritePeriod
;
;  DESCRIPTION:
...
;
;-----------------------------------------------------------------------------
 PWM_PH_C_WritePeriod:
_PWM_PH_C_WritePeriod:
   mov   REG[PWM_PH_C_PWM_PERIOD_REG], A
   ret
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_WritePulseWidth
;
;  DESCRIPTION:
...
;
;-----------------------------------------------------------------------------
 PWM_PH_C_WritePulseWidth:
_PWM_PH_C_WritePulseWidth:
   mov   REG[PWM_PH_C_PULSE_WIDTH_REG], A
   ret
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_WriteDeadTime
;
;  DESCRIPTION:
...
;
;-----------------------------------------------------------------------------
 PWM_PH_C_WriteDeadTime:
_PWM_PH_C_WriteDeadTime:
   mov   REG[PWM_PH_C_DEAD_TIME_REG], A
   ret
.ENDSECTION

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_PH_C_bReadPulseWidth
;
;  DESCRIPTION:
...
;
;-----------------------------------------------------------------------------
 PWM_PH_C_bReadPulseWidth:
_PWM_PH_C_bReadPulseWidth:
 bPWM_PH_C_ReadPulseWidth:  ; For backwards compatibility only.
_bPWM_PH_C_ReadPulseWidth:  ; For backwards compatibility only.
   mov   A, REG[PWM_PH_C_PULSE_WIDTH_REG]
   ret

.ENDSECTION

; End of File PWM_PH_C.asm
